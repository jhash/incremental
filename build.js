...
System.register('lib/bootstrap.js', ['npm:lodash@3.10.1'], function (_export) {
  'use strict';
...
System.register('lib/header.js', ['lib/jdom.js'], function (_export) {
  'use strict';
...
System.registerDynamic("npm:incremental-dom@0.3.0/dist/incremental-dom-cjs", ["github:jspm/nodelibs-process@0.1.2"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.registerDynamic("npm:incremental-dom@0.3.0", ["npm:incremental-dom@0.3.0/dist/incremental-dom-cjs"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = $__require('npm:incremental-dom@0.3.0/dist/incremental-dom-cjs');
  global.define = __define;
  return module.exports;
});

System.register('lib/jdom.js', ['npm:incremental-dom@0.3.0'], function (_export) {
  'use strict';

  var elementOpenStart, elementOpenEnd, attr, elementClose, text, attributes;
  ...
  function render(tag) {
    ...
    var tagText = _.get(tag, 'props.textBefore') || _.get(tag, 'props.text'),
  ...
  return {
    setters: [function (_npmIncrementalDom030) {
      elementOpenStart = _npmIncrementalDom030.elementOpenStart;
      elementOpenEnd = _npmIncrementalDom030.elementOpenEnd;
      attr = _npmIncrementalDom030.attr;
      elementClose = _npmIncrementalDom030.elementClose;
      text = _npmIncrementalDom030.text;
...
System.register('lib/main.js', ['lib/bootstrap.js', 'npm:incremental-dom@0.3.0', 'lib/header.js', 'lib/footer.js'], function (_export) {
  'use strict';

  var bootstrap, patch, header, footer;
  ...
  return {
    setters: [function (_libBootstrapJs) {
